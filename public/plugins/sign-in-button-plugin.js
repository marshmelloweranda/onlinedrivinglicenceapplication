/******************************************************************************
Mon Jul 21 2025 11:42:45 GMT+0000 (Coordinated Universal Time)
sign-in-with-esignet v0.9.0
A vanilla javascript component for rendering â€œSign in with..â€ button on mosip clientâ€™s web page for oidc integration.
Copyright 2025
MPL-2.0 license 
******************************************************************************/
var SignInWithEsignetButton = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function buildErrorRedirectUrl(errorDescription, errorCode, oidcConfig) {
        if (errorCode === void 0) { errorCode = "request_uri_error"; }
    ...
    function par_callback(callbackFunction, oidcConfig) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, callbackFunction(oidcConfig.client_id, oidcConfig.state, oidcConfig.ui_locales)];
    ...
    var SignInWithEsignet = function (_a) { return __awaiter(void 0, void 0, void 0, function () {
        var oidcConfig, buttonConfig, signInElement, style, errorMsg, urlToNavigate, onClickHandler, label, logoPath, baseStyle, buttonCustomStyle, buttonClasses, buttonStyle, button;
        var _b, _c;
        var props = __rest(_a, []);
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, promiseWithTimeout(par_callback(oidcConfig.par_callback, oidcConfig), timeoutMs)];
                            case 1:
                                result = _a.sent();
                                if (result === "timeout") {
